...
if mau_nambah.lower() == "hab":
    ...
    preferred_games_mcg = input("MCG Mau Game Apa Bossku? (Pisahkan dengan koma): ")
    preferred_game_list_mcg = [game.strip() for game in preferred_games_mcg.split(',')]
elif mau_nambah.lower() == "nlc":
    preferred_games_nlc = input("NLC Mau Game Apa Bossku? (Pisahkan dengan koma): ")
    preferred_game_list_nlc = [game.strip() for game in preferred_games_nlc.split(',')]
...
with open(filename, "w", encoding="utf-8") as file:
    ...
    if preferred_game_list_nlc:
        ...
        generated_results_nlc = generate_mcg_results(preferred_game_list_nlc)
